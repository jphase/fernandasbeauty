...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'salon');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Salon');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://www.cssigniter.com/support/viewforum.php?f=92');
