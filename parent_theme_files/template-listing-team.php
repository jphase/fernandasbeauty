		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					...
					<?php
						$cpt            = 'cpt_team';
						$cpt_taxonomy   = 'team-category';
						$masonry        = get_post_meta( get_the_ID(), 'team_listing_masonry', true );
						$isotope        = get_post_meta( get_the_ID(), 'team_listing_isotope', true );
						$columns        = get_post_meta( get_the_ID(), 'team_listing_columns', true );
						$posts_per_page = get_post_meta( get_the_ID(), 'team_listing_posts_per_page', true );
