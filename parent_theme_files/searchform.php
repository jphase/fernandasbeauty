<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" role="search" class="searchform">
	<div>
		...
		<button type="submit" value="<?php _e( 'GO', 'ci_theme' ); ?>" class="searchsubmit"><i class="fa fa-search"></i><span class="screen-reader-text"><?php _e( 'Search', 'ci_theme' ); ?></span></button>
	</div>
</form>